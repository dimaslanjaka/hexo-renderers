...
const validHtmlTags = sbgUtility.array_unique([
    ...headAndMetadataTags,
    ...sectioningTags,
    ...textContentTags,
    ...formAndInputTags,
...
function resolveValidHtmlTags() {
    ...
    if (typeof instance !== 'undefined') {
        const config$1 = config(instance);
        if ('html_tags' in config$1) {
            const html_tags = config$1.html_tags;
            if (Array.isArray(html_tags))
                fromConfig.push(...html_tags);
        }
    }
    return sbgUtility.array_unique(validHtmlTags.concat(fromConfig));
}

exports.descriptionListTags = descriptionListTags;
exports.formAndInputTags = formAndInputTags;
exports.headAndMetadataTags = headAndMetadataTags;
exports.latexTags = latexTags;
exports.listTags = listTags;
exports.mathjaxTags = mathjaxTags;
exports.mediaTags = mediaTags;
exports.obsoleteTags = obsoleteTags;
exports.resolveValidHtmlTags = resolveValidHtmlTags;
exports.scriptAndInteractiveTags = scriptAndInteractiveTags;
exports.sectioningTags = sectioningTags;
exports.tableTags = tableTags;
exports.texTags = texTags;
exports.textContentTags = textContentTags;
exports.uncategorizedTags = uncategorizedTags;
