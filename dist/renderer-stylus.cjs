...
if (typeof require === 'undefined')
    global.require = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('renderer-stylus.cjs', document.baseURI).href)));
...
exports.rendererStylus = rendererStylus;
exports.stylusFn = stylusFn;
