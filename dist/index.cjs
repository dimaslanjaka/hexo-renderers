...
// src/index.ts
var import_sbg_utility7 = require("sbg-utility");
...
function registerCustomHelper(hexo2) {
  ...
  for (const key in hexoUtil) {
    if (Object.prototype.hasOwnProperty.call(hexoUtil, key)) {
      ...
      if (typeof helper === "function") hexo2.extend.helper.register(key, helper);
    }
  }
}
...
async function renderer(data, _options) {
  ...
  (0, import_sbg_utility6.writefile)((0, import_path5.join)(hexo2.base_dir, "tmp/config/rollup.json"), (0, import_sbg_utility6.jsonStringifyWithCircularRefs)({ input, output, path: path12 }));
  try {
...
if (typeof hexo !== "undefined") {
  ...
  hexo.extend.filter.register("after_clean", function() {
    return (0, import_sbg_utility7.del)(import_upath3.default.join(hexo.base_dir, "tmp/hexo-renderers"));
  });
